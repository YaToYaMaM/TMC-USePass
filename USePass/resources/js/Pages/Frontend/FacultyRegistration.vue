...
const form = ref({
    faculty_id: props.generatedFacultyId || '',
    faculty_first_name: '',
    faculty_last_name: '',
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        <div>
                            <label class="block text-sm font-medium mb-1 text-gray-700">
                                Faculty/Staff ID
                                <span class="ml-2 text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full">Auto-generated</span>
                            </label>
                            <div class="relative">
                                <input
                                    type="text"
                                    v-model="form.faculty_id"
                                    class="w-full px-3 py-2 pr-10 border border-gray-400 rounded-md bg-gray-50 font-mono text-base text-gray-700 cursor-not-allowed focus:outline-none"
                                    readonly
                                    required
                                />
                            ...
                            <p class="text-xs text-gray-500 mt-1 flex items-center">
                                ...
                                This ID has been automatically assigned to you
                            </p>
                        </div>
                        <div>
